...
module.exports = class FriendlyFrame extends React.Component {
  static propTypes = {
  ...
  componentDidMount() {
    ...
    const url = src || basename + createPath(location);

    this.log("verbose", () => {
      console.log("Parent: Instantiating iFrame", url);
    });
  ...
  render() {
    const { location, onChangeLocation, debugLevel, src, ...rest } = this.props;
